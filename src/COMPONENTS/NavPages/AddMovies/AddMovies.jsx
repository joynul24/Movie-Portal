const AddMovies = () => {
  ...
  return (
    <div className="text-white container mx-auto mt-5 md:mt-10 px-1 md:px-0">
      ...
      <form onSubmit={hangleAddMovie} className=" bg-base-100 shrink-0 shadow-2xl text-black p-8 rounded-xl">
        ...
        <div className="md:flex gap-6 mb-6">
          ...
          <div className="form-control md:w-1/2">
            ...
            <select name="year" type="number" defaultValue="genre" className="select w-full">
