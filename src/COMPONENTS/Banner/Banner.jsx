        ...
        >
          <div className="text-white text-center lg:max-w-[50%] mx-auto py-[50px] lg:py-[150px]">
            <h2 className="text-2xl lg:text-5xl font-bold mb-6">
              Unlimited Movie, TVs <span className="text-[#E4D804]">Shows</span>, & More.
            </h2>
            <p className="text-base font-inter">
              Stream the latest blockbusters and timeless classics, Enjoy
              exclusive content anytime, anywhere, Experience high-quality
              streaming without limits, Your ultimate movie destination awaits!
            </p>
