...
const Service = () => {
  return (
    <div className="mb-20">
      ...
      <div className="bg-[#201F25] mt-20 pt-6 pb-6">
        <div className="text-white container mx-auto  px-3 md:px-0">
              ...
              <div className="flex gap-5 items-center">
                ...
                <div>
                  ...
                  <p className="text-[#8F8F8F] f-lato mt-2">
                    Here are the TV viewing options and you <br /> can select
                    your choice and watch on TV very well
                  </p>
                </div>
              </div>
