  ...
  return (
    <div className="bg-[#15151F] pt-10">
      <div className="text-white container mx-auto mb-20 px-2 md:px-0">
        ...
        <div className="flex flex-col md:flex-row gap-6 justify-between mt-10 pb-20">
          {/* box-1 */}
          <div className="bg-[#1F1E24] rounded-xl hover:border-2 hover:border-[#E4D804] px-15 py-10">
